...
public class ZTestReport implements IReporter {
	...
	private String path = System.getProperty("user.dir") + File.separator + "src/test/java/com/example/Assets" + File.separator+"report.html";

	private String templatePath = System.getProperty("user.dir") + File.separator + "src/test/java/com/example/Assets/template";
